...
impl Orientation {
    ...
    fn front_face_and_its_rotation(self) -> (usize, FaceRotation) {
        ...
        match (x, y, z) {
            ...
            (-1, 2, -3) => (5, FaceRotation::None),
            (-1, 3, 2) => (4, FaceRotation::Counterclockwise),
            (-2, -1, -3) => (5, FaceRotation::Counterclockwise),
            (-2, -3, 1) => (1, FaceRotation::Clockwise),
            ...
            (-3, 2, 1) => (1, FaceRotation::UpsideDown),
