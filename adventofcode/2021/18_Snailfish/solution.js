...
assert.deepEqual(explode([[[[[1, 1], [1, 1]], 2], 3], 4]), [[
  [[0, [2, 1]], 2],
  3,
], 4]);
assert.deepEqual(explode([7, [6, [5, [4, [3, 2]]]]]), [7, [6, [5, [7, 0]]]]);
assert.deepEqual(explode([[6, [5, [4, [3, 2]]]], 1]), [[6, [5, [7, 0]]], 3]);
assert.deepEqual(explode([[3, [2, [1, [7, 3]]]], [6, [5, [4, [3, 2]]]]]), [[3, [
  2,
  [8, 0],
]], [9, [5, [4, [3, 2]]]]]);
assert.deepEqual(explode([[3, [2, [8, 0]]], [9, [5, [4, [3, 2]]]]]), [[3, [2, [
  8,
  0,
]]], [9, [5, [7, 0]]]]);
...
assert.deepEqual(reduce_snailfish_number([45, 1]), [[[[5, 6], [5, 6]], [
  [5, 6],
  [6, 6],
]], 1]);

assert.deepEqual(explode([[1, [5, [7, [2, 5]]]], [[[[4, 6], 3], 2], 4]]), [[1, [
  5,
  [9, 0],
]], [[[[9, 6], 3], 2], 4]]);
assert.deepEqual(explode([[1, [5, [9, 0]]], [[[[9, 6], 3], 2], 4]]), [[1, [5, [
  9,
  9,
]]], [[[0, 9], 2], 4]]);
